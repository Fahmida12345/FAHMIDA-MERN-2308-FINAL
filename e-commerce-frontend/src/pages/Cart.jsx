...
const Cart = () => {
  ...
  const gotoCheckout = () => {
    nevigate("/checkout", { state: { key: cart } });
  };
  return (
    <main>
      <Container>
                ...
                <div className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)]">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="mt-auto flex items-center gap-3">
                        <button
                          ...
                          type="button"
                          className="flex items-center cursor-pointer justify-center w-5 h-5 bg-red-400 outline-none rounded-full"
                        >
                          <svg
                        ...
                        <button
                          ...
                          type="button"
                          className="flex items-center cursor-pointer justify-center w-5 h-5 bg-green-800 outline-none rounded-full"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="w-2 fill-white"
                  ...
                  <div className="ml-auto flex flex-col">
                    ...
                    <h3 className="text-sm sm:text-base font-semibold text-slate-900 mt-auto">
                      BDT {item?.product?.discountPrice * item?.quantity}
                    </h3>
                  </div>
                </div>
              ))}
